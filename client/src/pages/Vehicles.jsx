      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-8">
        ...
        <div className="flex gap-2 md:gap-3 mb-6">
          ...
          <button
            ...
            className={`px-4 md:px-5 py-3 rounded-xl font-medium flex items-center gap-2 transition-all border text-sm ${
        ...
        {/* Filters Panel */}
        {showFilters && (
          <div className="bg-white rounded-2xl p-4 md:p-6 mb-6 md:mb-8 border border-slate-200">
            ...
            <div className="flex flex-wrap gap-3 mt-4 md:mt-5">
              <button
                ...
                className="bg-slate-900 hover:bg-slate-800 text-white px-5 md:px-6 py-2.5 rounded-lg font-medium transition-colors text-sm"
              >
                Apply Filters
              </button>
              {hasActiveFilters && (
                <button
                  ...
                  className="text-slate-500 hover:text-slate-900 flex items-center gap-2 px-4 font-medium transition-colors text-sm"
                >
                  <X className="w-4 h-4" />
                  Clear all
                </button>
        ...
        {loading ? (
          ...
          <div className="text-center py-16 md:py-20 bg-white rounded-2xl border border-slate-200">
              ...
              >
                ...
                <div className="h-48 sm:h-52 md:h-56 overflow-hidden relative">
                  ...
                  <div className="absolute top-3 md:top-4 left-3 md:left-4">
                    <span className="bg-slate-900 text-white text-xs font-bold px-2.5 md:px-3 py-1 md:py-1.5 rounded-full uppercase tracking-wide">
                      {vehicle.type}
                    </span>
                  </div>
                  {vehicle.avgRating > 0 && (
                    <div className="absolute top-3 md:top-4 right-3 md:right-4 bg-white/95 backdrop-blur-sm rounded-full px-2 md:px-2.5 py-1 flex items-center gap-1">
                ...
                <div className="p-4 md:p-5">
                  <h3 className="font-bold text-base md:text-lg text-slate-900 group-hover:text-amber-600 transition-colors">
                    {vehicle.name}
                  </h3>
