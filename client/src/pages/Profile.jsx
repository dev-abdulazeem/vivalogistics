...
import { Mail, Phone, Shield, Trash2, AlertTriangle, Loader2 } from "lucide-react";
...
export default function Profile() {
  ...
  const handleDeleteAccount = async () => {
    ...
    try {
      ...
      setDeleteError(error.response?.data?.message || "Failed to delete account. Try again.");
      setIsDeleting(false);
    }
  };
  ...
  return (
    <div className="min-h-screen bg-slate-50 py-8 md:py-12 px-4">
      <div className="max-w-2xl mx-auto">
        <h1 className="text-2xl md:text-3xl font-bold text-slate-900 mb-6 md:mb-8">My Profile</h1>

        {/* Profile card */}
        <div className="bg-white rounded-2xl border border-slate-100 p-5 md:p-8 mb-6">
          <div className="flex items-center gap-4 md:gap-5 mb-6 md:mb-8">
            <div className="w-16 h-16 md:w-20 md:h-20 rounded-full bg-amber-100 flex items-center justify-center shrink-0">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-3 md:gap-4 p-3 md:p-4 bg-slate-50 rounded-xl">
              ...
              {user?.emailVerified ? (
                ...
                <span className="text-amber-600 text-xs font-medium shrink-0">Unverified</span>
              )}
            </div>
        ...
        {/* Danger zone */}
        <div className="bg-white rounded-2xl border border-red-100 p-5 md:p-8">
          <h3 className="text-base md:text-lg font-semibold text-slate-900 mb-2">Danger Zone</h3>
          <p className="text-sm text-slate-500 mb-6">
            Once you delete your account, all your data and bookings will be permanently removed.
      ...
      {showDeleteModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-2xl p-6 md:p-8 max-w-md w-full shadow-2xl mx-4">
            ...
            <div className="bg-red-50 border border-red-100 rounded-xl p-4 mb-6">
              <p className="text-sm text-red-700 leading-relaxed">
                All your bookings, saved vehicles, and personal data will be permanently deleted.
